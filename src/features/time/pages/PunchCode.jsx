// src/features/time/pages/PunchCodes.jsx
import React, { useState } from "react";
import { QRCodeSVG } from "qrcode.react";
import { buildPunchQr } from "../lib/punchFormat.js";
...
export default function PunchCodes() {
  ...
  const directLink = `#/punch?e=${encodeURIComponent(form.employeeId)}&a=${form.action}&site=${encodeURIComponent(form.siteId)}&n=${encodeURIComponent(form.employeeName)}`;
